    ...
    private fun initViews() {
        ...
        adapter.onMuseumClickListener =
            MuseumByTypeAdapter.OnMuseumClickListener { museumDataDto, _ ->
                ...
                intent.putExtra("museumCountry", museumDataDto.country)
                intent.putExtra("museumDesc", museumDataDto.description)
                intent.putExtra("museumWork", museumDataDto.workTime)
                intent.putExtra("museumImage", museumDataDto.images?.get(0)?.imagePath)
                intent.putExtra("museumType1", museumDataDto.types?.get(0)?.name)
                intent.putExtra("museumType2", museumDataDto.types?.get(1)?.name)
